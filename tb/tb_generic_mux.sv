...
module tb_generic_mux;
    ...
    // Safeguard for width calculation
    reg [($clog2(NUM_INPUTS) > 0 ? $clog2(NUM_INPUTS)-1 : 0):0] sel;
    ...
    // FIX 1: Initialize clock so it can toggle
    initial begin
        clk = 0;
    end
    ...
    initial begin
        ...
        for (i = 0; i < NUM_INPUTS; i = i + 1) begin
            ...
            @(posedge clk);
            #1; // Wait for clock edge + hold time settling
